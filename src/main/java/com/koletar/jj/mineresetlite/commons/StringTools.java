...
public class StringTools {
  ...
  /**
   * Build a spaced argument out of an array of args that don't contain spaces, due to the command
   * delimiter.
   *
   * @param args String array of args
   * @param start Number of elements to skip over/index to begin at
   * @param stop Number of elements at the <b>end of the array</b> to ignore,
