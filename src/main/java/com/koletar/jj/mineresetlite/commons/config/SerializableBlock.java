package com.koletar.jj.mineresetlite.commons.config;
...
public class SerializableBlock {
  ...
  public SerializableBlock(String self) {
    ...
    if (bits.length != 2) {
      throw new IllegalArgumentException(
          "String form of SerializableBlock didn't have exactly 2 numbers");
    }
    try {
  ...
  public boolean equals(Object o) {
    return o instanceof SerializableBlock
        && (this.blockId == ((SerializableBlock) o).blockId
        && this.data == ((SerializableBlock) o).data);
  }
}
